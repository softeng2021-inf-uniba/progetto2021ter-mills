...
public final class Strings {
  ...
  /**
   * Costanti utilizzate per mostrare a schermo il format del testo
   * nel banner iniziale.
   */
  ...
  /**
   * Costanti utilizzate per mostrare a schermo i colori del banner iniziale (verde, bianco, rosso).
   */
  ...
  /**
   * Costanti utilizzate per mostrare a schermo il colore (nero)
   * della scritta nel banner iniziale.
   */
  public static final String ANSI_BLACK_FG = "\u001B[30m";
  /**
   * Costanti utilizzate per mostrare a schermo il colore
   * della damiera e i colori delle pedine.
   */
  ...
  /**
   * Costanti utilizzate per mostrare a schermo le pedine:
   * sia dame che semplici pedine.
   */
  ...
  /**
   * Stringa di benvenuto iniziale che combina varie costanti tra loro.
   */
  ...
  /**
   * Descrizioni dei comandi disponibili nell'app.
   */
  ...
  /**
   * Stringhe relative al comando 'help'.
   */
  public static final String HELP_MSG =
      "Comandi disponibili:\n" + HELP + GIOCA + ABBANDONA + ESCI + NUMERI + DAMIERA
          + TEMPO + PRESE + MOSSE + SPOSTAMENTI;
  public static final String SUGGERIMENTO_HELP = "Digitare un comando o scrivere 'help' per "
      + "visualizzare la lista " + "dei comandi disponibili\n";
  ...
  /**
   * Costanti per le varie stringhe in gioco.
   */
  ...
  /**
   * Costanti utilizzate per il comando 'abbandona' / 'esci'.
   */
